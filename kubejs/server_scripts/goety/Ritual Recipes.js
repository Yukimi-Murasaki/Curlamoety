...
ServerEvents.recipes(event=>{//kjs goety方法 
    ...
    .soulCost(444)
    .duration(44)
    .entityToConvertDisplayName("entity.minecraft.skeleton")
    ...
    .entityToConvertDisplayName("entity.minecraft.wandering_trader")
    ...
    .entityToConvertDisplayName("entity.minecraft.witch")
