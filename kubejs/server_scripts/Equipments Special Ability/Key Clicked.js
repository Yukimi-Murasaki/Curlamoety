NetworkEvents.dataReceived("global.armorSetKey.consumeClick",(event)=>{
    ...
    if(player.persistentData.armorset == "apocalyptium"){
        //神金
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
            ...
            player.persistentData.generic_summon_cd = 3600
        }else{
            player.setStatusMessage(Text.red(Text.translate("curlamoety.lang.armorset_cooling")))
        }
    }else if(player.persistentData.armorset == "diamond"){
        //钻石
    ...
    }else if(player.persistentData.armorset == "leather"){
        //皮革
        if(player.persistentData.generic_cd == 0||player.persistentData.generic_cd == -1){
            let summon = level.createEntity("trials:wind_charge")
            summon.setPosition(x,y,z)
            summon.setMotion(0,-1,0)
            summon.setOwner(player)
            summon.spawn()
            player.persistentData.generic_cd = 40
        }
    }else if(player.persistentData.armorset == "ignitium"){
        //腾炎
        if(player.persistentData.ignitium_cd == 0||player.persistentData.ignitium_cd == -1){
            ...
            player.persistentData.ignitium_cd = 1200
        }else{
            player.setStatusMessage(Text.red(Text.translate("curlamoety.lang.armorset_cooling")))
        }
    }else if(player.persistentData.armorset == "arctic"){
        //极地
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
    ...
    }else if(player.persistentData.armorset == "fiery"){
        //炽铁
        if(player.potionEffects.isActive("goety:flame_hands")){
            ...
            if(amplifier >=4 ){
                ...
                player.persistentData.fiery_cd = 20
            }else{
    ...
    }else if(player.persistentData.armorset == "yeti"){
        //雪怪
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
    ...
    }else if(player.persistentData.armorset == "cursium"){
        //咒魂
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
    ...
    }else if(player.persistentData.armorset == "champion"){
        //冠军
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
    ...
    }else if(player.persistentData.armorset == "spider"){
        //蜘蛛
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
    ...
    }else if(player.persistentData.armorset == "spider_darkmage"){
        //神经
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
            let summon = level.createEntity("goety:bone_spider_servant")
            summon.setPosition(x,y,z)
    ...
    }else if(player.persistentData.armorset == "cursed_knight"){
        //诅咒骑士
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
    ...
    }else if(player.persistentData.armorset == "cursed_paladin"){
        //诅咒圣骑士
        if(player.persistentData.generic_summon_cd == 0||player.persistentData.generic_summon_cd == -1){
    ...
    }else if(player.persistentData.armorset == "black_iron"){
        //黑铁
    ...
    }else if(player.persistentData.armorset == "dark"){
        //黑暗
